...
<div class="content">
  <h1 class="title aurora-text">SaftladenSuite pro max</h1>
  <p class="subtitle">Barcode Übertragungs Menü</p>

  <div class="barcode-container">
    <form class="barcode-form">
      <div class="barcode-input-wrapper">
        <input type="text" name="search" placeholder="Bitte hier Barcode eingeben" autofocus>
